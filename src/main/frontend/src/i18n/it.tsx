    ...
    calendar: {
      ...
      event: {
        ...
        labels: {
          ...
          hide_timezone: "Nascondi fuso orario",
          start_date_timezone: "Fuso orario della data di inizio",
          end_date_timezone: "Fuso orario della data di fine",
          ...
          months: "Mesi",
          years: "Anni",
          stop_after: "Interrompi dopo",
          never: "Mai",
          date: "Data",
          occurrences: "Occorr.",
          until_date: "Fino alla data",
          until_occurrences: "Numero di occorrenze"
        }
      },
      calendarlist: {
        number: "Matricola",
      ...
      dialog: {
        ...
        edit_recurring_event_title: "Modifica evento ricorrente",
      }
    },
    users: {
      password_update: {
